...
class User3Page extends StatefulWidget {
  const User3Page({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _User3PageState createState() => _User3PageState();
}

class _User3PageState extends State<User3Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(' المستخدم 3', style: TextStyle(color: Colors.white)),
        centerTitle: true,
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: _firestore
                  ...
                  // We fetch all visible data for this user to filter by day locally
                  .snapshots(),
              builder: (context, snapshot) {
                ...
                // Filtering the results to match ONLY the day (ignoring year/month)
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildInfoRow(
                                      Icons.event_note,
                                      ' يوم :',
                                      DateFormat('d').format(customer['date'].toDate())),
                                ],
                              ),
                            ),
                          );
          ...
          StreamBuilder<Map<String, dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                controller.text3.value = data['text3'] ?? '';
